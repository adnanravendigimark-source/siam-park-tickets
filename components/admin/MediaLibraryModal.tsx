                ...
                return (
                  <div key={item.id} className="flex flex-col gap-1">
                    <button
                      ...
                      title={tooltip}
                      className="group relative aspect-square overflow-hidden rounded-lg border border-stone-200 bg-stone-100 transition hover:border-chichen-navy hover:ring-2 hover:ring-chichen-navy/40"
                    >
