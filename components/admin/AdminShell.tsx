      ...
      >
        <aside className="hidden h-screen w-64 flex-col overflow-y-auto bg-stone-900 text-white sm:flex">
          ...
          <div className="flex items-center gap-2.5 border-b border-white/10 px-5 py-5">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-full bg-white/5 ring-1 ring-white/15">
              <svg viewBox="0 0 48 48" fill="none" className="h-6 w-6" aria-hidden="true">
                <path
                  ...
                  strokeLinecap="round"
                />
                <path d="M6 22c0-5.5 4-9 9-9s9 3.5 9 9z" fill="#D9A441" fillOpacity="0.3" stroke="#D9A441" strokeWidth="2" strokeLinejoin="round" />
